...
![](img/renv_backgroud.drawio.svg){fig-align="center"}
...
::: {.column width="50%"}
![](img/renv_cloud.drawio.svg){fig-align="center"}
:::
...
- Need to sync-ignore (e.g. [Dropbox](https://help.dropbox.com/sync/ignored-files))
- Packages in `renv` are _git-ignored_ by default
...
1. Confirm you can run any file in `code/`
