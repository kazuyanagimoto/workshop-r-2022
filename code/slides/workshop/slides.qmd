...
## {background-color="#1C5253" visibility="uncounted"}

::: {.title}
An Advanced Introduction to {{< fa brands r-project >}}
:::
...
You can find a benchmark in tomaztsql's [blog](https://www.r-bloggers.com/2022/05/comparing-performances-of-csv-to-rds-parquet-and-feather-file-formats-in-r/)
...
- For more instructions, you can refer to Tom Mock's [slides](https://jthomasmock.github.io/arrow-dplyr/)
...
Alternatively, create a custom theme and color palette (Andrew Heiss's [code](https://github.com/andrewheiss/who-cares-about-crackdown/blob/ad6312957de927674a5da2437a2f993e52f53d88/R/graphics.R))
